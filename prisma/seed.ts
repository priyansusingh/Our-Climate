...
async function main() {
  ...
  for (const pledge of pledges) {
    await prisma.pledge.create({ data: pledge })
  }
  ...
  const events = [
    {
      ...
      description: 'Join us for a day of tree planting in Central Park. All ages welcome! We\'ll provide tools and refreshments.',
    ...
    },
    {
      ...
      description: 'Learn about the latest climate science research and how you can take action in your daily life.',
    ...
    },
    {
      ...
      description: 'Help us clean up Ocean Beach and protect marine life from plastic pollution.',
    ...
    },
    {
      ...
      description: 'Join millions worldwide in demanding climate action from world leaders.',
    ...
    },
    {
      ...
      description: 'Online workshop on how to transition your home to renewable energy sources.',
